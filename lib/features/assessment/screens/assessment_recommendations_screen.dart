...
class AssessmentRecommendationScreen extends StatelessWidget {
  final List<int> arrangedCaps;

  const AssessmentRecommendationScreen({
    super.key,
  ...
  void _goToGabEyeCamera(BuildContext context) {
    // TODO: navigate to the GabEye Camera screen once it exists.
    ScaffoldMessenger.of(context).showSnackBar(
      const SnackBar(content: Text('GabEye Camera coming soon')),
    );
  }

              ...
              child: Column(
                children: [
                  ...
                  ElevatedButton(
                    ...
                    child: Text(
                      _hasScrolledToBottom ? 'I Accept' : 'Scroll to Accept',
  ...
  Widget _buildTermsTextContent(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        ...
        _buildBulletPoint('This is not a medical diagnosis. Results from this assessment do not confirm, rule out, or replace a clinical evaluation.', bodyStyle),
        _buildBulletPoint('Digital color tests can be affected by things like your screen\'s color accuracy and the lighting in the room. For a confirmed diagnosis, please see a licensed eye care specialist.', bodyStyle),
        ...
        _buildBulletPoint('Be mindful of your surroundings when using GabEye outdoors or in unfamiliar spaces. GabEye is a visual aid, not a substitute for careful awareness of your environment.', bodyStyle),
        ...
        _buildBulletPoint('Camera and image data are processed on-device. Live camera streams and uploaded images are analyzed locally using on-device tools. This data isn\'t sent anywhere outside your phone.', bodyStyle),
        _buildBulletPoint('We follow the Data Privacy Act of 2012 (Republic Act No. 10173). Because your color vision profile is sensitive personal information, we\'ve designed GabEye\'s architecture specifically to avoid the risks that come with cloud-based storage.', bodyStyle),
